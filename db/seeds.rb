...
note1 = Note.new(description: "Created repo and began backend on 9/18 after changing project idea. Goal is to complete backend by 9/18 and start front-end on 9/19", task_id: 1, reminder_id: 1)
note2 = Note.new(description: "Confirmation number for dinner: 7G6PW")
